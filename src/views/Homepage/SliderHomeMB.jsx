      ...
      >
        <SwiperSlide>
          <div className="mt-5 h-full w-[360px] cursor-pointer shadow-md sm:h-[440px] sm:w-[450px]">
            <div className="flex h-[390px] w-full flex-col items-center justify-center rounded-lg bg-[#003049] px-7 sm:h-full">
              <h3 className="mb-5 mt-7 text-[24px] font-semibold text-white sm:mt-0 sm:text-[28px]">
        ...
        <SwiperSlide>
          <div className="mt-5 h-full w-[360px] cursor-pointer shadow-md sm:h-[420px] sm:w-[450px]">
            <div className="flex h-[390px] w-full flex-col items-center rounded-lg bg-[#003049] px-7 sm:h-full">
