                ...
                <SwiperSlide>
                    <div className=' grid sm:grid-cols-12 grid-cols-1 place-items-center justify-between w-full'>
                        ...
                        <div className=' sm:col-span-6 ml-10'>
                            <h2 className=' md:text-[30px] xl:text-start sm:text-[22px] text-[20px] tracking-widest font-extrabold leading-tight mb-5'>
                                TIPS CHOICE BEST <br /> AGENCY For House <br /> Decoration
                            </h2>
                            <p className=' sm:text-[15px] xl:text-start'>Lorem ipsum dolor sit amet, consectetur adipiscing <br /> elit, sed do eiusmod tempor incididunt ut labore et <br /> dolore magna aliqua. </p>
                        </div>
                    </div>
                </SwiperSlide>
                <SwiperSlide>
