...
export const ExampleService = () => {
    ...
    return (
        <div className=' w-full bg-white mb-32 sm:mb-20 container mx-auto h-full max-w-[340px] sm:max-w-[620px] md:max-w-[700px] lg:max-w-[900px] xl:max-w-6xl'>
            <div className=' flex items-center gap-x-5 justify-between mb-5'>
                <h1 className=' md:text-[28px] lg:text-[30px] font-bold text-[20px] lg:leading-[1.2]'>
            ...
            <div className=' grid grid-cols-1 lg:grid-cols-3 sm:grid-cols-2 place-items-center gap-10 sm:gap-5 lg:gap-6 '>
                <div className=' w-[320px] sm:w-[300px] md:w-[340px] lg:w-[290px] xl:w-[350px] flex flex-col items-center cursor-pointer p-3 hover:shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] rounded-md border-2
                    duration-300 ease-in-out'>
                    <img src={screenImg} alt=""
                        className=' w-[320px] sm:w-[300px] md:w-[340px] lg:w-[290px] xl:w-[340px]'
                    />
                    <h2 className=' mb-2 mt-3 text-center sm:text-[28px] w-full text-[20px] xl:text-[28px] leading-[1.2] lg:text-[26px] sm:mt-2 sm:mb-4 font-semibold'>
