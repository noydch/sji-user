    ...
    return (
        <Navbar>
            <div>
                ...
                <div className=' h-full w-full bg-white mb-20 sm:mt-0 mt-5 mx-auto max-w-[340px] sm:max-w-[620px] md:max-w-[700px] lg:max-w-[900px] xl:max-w-6xl p-2'>
                    <h1 className=' sm:text-[30px] text-[20px] lg:text-[35px] text-black font-black sm:pb-10 md:pb-4 pb-2 pt-5 sm:pt-7'>
                        TIPS CHOICE BEST AGENCY For <br /> House Decoration
                    </h1>
                    <div className=' grid-cols-1 md:grid-cols-2 sm:grid place-items-center gap-6'>
                        <div className=' mb-10 md:w-[330px] md:h-[230px] lg:w-[350px] lg:h-[220px] shadow-[6px_6px_13px_4px_#00000024] rounded-xl'>
                            <img src={goldImg} alt=""
                                className=' rounded-xl h-[200px] md:h-[230px] lg:h-[220px] w-full object-cover'
                            />
                        </div>
                        <div>
                            <p className=' mb-5'>
