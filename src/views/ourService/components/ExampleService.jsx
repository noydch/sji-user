  ...
  return (
    <div className="container mx-auto mb-32 h-full w-full max-w-[340px] bg-white sm:mb-20 sm:max-w-[620px] md:max-w-[700px] lg:max-w-[900px] xl:max-w-6xl">
      <div className="mb-5 flex items-center justify-between gap-x-5">
        <h1 className="text-[20px] font-bold md:text-[28px] lg:text-[30px] lg:leading-[1.2]">
          {t("OurService.example.title")}
        </h1>
        <button className="flex w-[120px] items-center justify-center rounded bg-[#F97316] px-4 py-[6px] text-[20px] text-white">
      ...
      <div className="grid grid-cols-1 place-items-center gap-10 sm:grid-cols-2 sm:gap-5 lg:grid-cols-3 lg:gap-6">
        <div className="flex w-[320px] cursor-pointer flex-col items-center rounded-md border-2 p-3 duration-300 ease-in-out hover:shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] sm:w-[300px] md:w-[340px] lg:w-[290px] xl:w-[350px]">
          <img
            src={screenImg}
            alt=""
